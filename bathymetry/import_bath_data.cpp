...
#define set_from_map_fc F77_FUNC(set_from_map, SET_FROM_MAP)
        void set_from_map_fc(const char* filename, const FType *X, const FType *Y, const FType *Z, FType *depth, int *ncolumns);

#define set_from_map_beta_fc F77_FUNC(set_from_map_beta, SET_FROM_MAP_BETA)
        void set_from_map_beta_fc(const char* filename, const FType *X, const FType *Y, FType *depth, int *ncolumns, FType *surf_h);

}

void set_from_map_fc(const char* filename, const FType *X, const FType *Y, const FType *Z, FType *depth, int *n){
...
void set_from_map_beta_fc(const char* filename, const FType *X, const FType *Y, FType *depth, int *n, FType *surf_h){
