...
#define get_field_values_fc F77_FUNC(get_field_values, GET_FIELD_VALUES)
        void get_field_values_fc(const char* filename, const FType *X, const FType *Y, FType *Z, int *nodes);

}

void get_field_values_fc(const char* filename, const FType *X, const FType *Y, FType *Z, int *n){
