...
43  FLExit("Unable to open "//trim(lfilename))
  ...
  subroutine read_nodes_coords( fd, filename, gmshFormat, nodes )
    ...
    ! Curious bug involving binary formatting and ASCII, that only happens
    ! on Intel ifort 15.0.1
#if __INTEL_COMPILER==1500 && __INTEL_COMPILER_UPDATE==1
