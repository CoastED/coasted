...
#include "petsc_legacy.h"
  ...
  type(PetscReal), parameter, private :: dummy_petsc_real = 0.0
  integer, parameter, public :: PetscReal_kind = kind(dummy_petsc_real)
  type(PetscScalar), parameter, private :: dummy_petsc_scalar = 0.0
  ...
  interface
    subroutine myMatGetInfo(A, flag, info, ierr)
       type(Mat), intent(in):: A
       type(MatInfoType), intent(in):: flag
